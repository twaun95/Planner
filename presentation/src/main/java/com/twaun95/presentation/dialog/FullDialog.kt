...
import com.twaun95.presentation.databinding.DialogFullBinding
...
) : BaseDialog<DialogFullBinding>(R.layout.dialog_full){
...
//        }
    ...
    companion object {
        private const val TAG = "FullDialog"
        ...
        fun show(
            ...
            return FullDialog(buttonType, content, onDismissListener, onCancelListener, onConfirmListener)
